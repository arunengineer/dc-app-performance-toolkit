...
def test_1_selenium_agent_custom_action_admp_association(jsm_webdriver, jsm_datasets, jsm_screen_shots):
    extension_ui_agents.app_specific_action_admp_association(jsm_webdriver, jsm_datasets)

def test_1_selenium_agent_custom_action_admp_associate_new(jsm_webdriver, jsm_datasets, jsm_screen_shots):
    extension_ui_agents.app_specific_action_admp_associate_new(jsm_webdriver, jsm_datasets)
